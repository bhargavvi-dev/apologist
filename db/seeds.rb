...
brand = Brand.create_with(prefix: 'adv', phone_number: '99999999', email: 'contact@advocate.in', slug: 'advocat').find_or_create_by!(name: 'advocate')
